...
export default function Notes() {
  const { fetchNotes, addNote, updateNote, deleteNote, notes, loading } =
    useNotes();
  ...
  const handleEditSubmit = async() => {
    await updateNote(seletedNote._id, editNote);
    setEditNote({});
    setModalMode(null);
      ...
      >
        <div className="flex flex-col gap-4">
          <div>
            {" "}
            {/*Note title */}
            <p className="text-white text-xl">{seletedNote?.title}</p>
          </div>
          ...
          <div>
            ...
            <p className="text-white">{seletedNote?.subject}</p>
          </div>

          <div className="">
            {" "}
            {/* Note content */}
            <p className="text-gray-400 text mb-1 ">Content</p>
            <p className="w-full min-w-3xs h-80 px-4 py-3 rounded-xl text-sm text-white border border-white/10 focus:outline-none focus:border-primary resize-none scrollbar-hide">
              {seletedNote?.content}
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-4">
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="e.g Your note content here..."
              className="w-full min-w-3xs h-80 px-4 py-3 rounded-xl text-sm text-white border border-white/10 focus:outline-none focus:border-primary resize-none scrollbar-hide"
              style={{ background: "rgba(255,255,255,0.04)" }}
            />
          </div>
